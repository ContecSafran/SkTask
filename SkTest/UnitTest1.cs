...
namespace SkTest
{
    ...
    public class ApiSearch
    {
        ...
        public void SearchTest()
        {
            ...
            string msg = "정보가 없습니다";
            string msg_2 = "";
            string json = "{\"query\":{\"filters\":{\"armour_filters\":{\"disabled\":true},\"heist_filters\":{\"disabled\":true,\"filters\":{}},\"map_filters\":{\"disabled\":true,\"filters\":{}},\"misc_filters\":{\"disabled\":true,\"filters\":{}},\"req_filters\":{\"disabled\":true},\"socket_filters\":{\"disabled\":true,\"filters\":{}},\"trade_filters\":{\"disabled\":false,\"filters\":{\"indexed\":{\"option\":\"1week\"},\"sale_type\":{\"option\":\"priced\"}}},\"type_filters\":{\"filters\":{\"category\":{\"option\":\"flask\"},\"rarity\":{\"option\":\"magic\"}}},\"ultimatum_filters\":{\"disabled\":true,\"filters\":{}},\"weapon_filters\":{\"disabled\":true}},\"stats\":[{\"filters\":[{\"disabled\":false,\"id\":\"pseudo.pseudo_number_of_empty_prefix_mods\"},{\"disabled\":false,\"id\":\"explicit.stat_962725504\",\"value\":{\"max\":39,\"min\":39}}],\"type\":\"and\"}],\"type\":\"자수정 플라스크\",\"status\":{\"option\":\"online\"}},\"sort\":{\"price\":\"asc\"}}";
            url_string = Search.RS.TradeApi[0] + "Affliction";
            json_entity = json;
            string request_result = Search.Api.SendHTTP(json_entity, url_string, 5);
                                ...
                                if (json_result != "")
                                {
                                    ...
                                    for (int i = 0; i < fetchData.Result.Length; i++)
                                    {
                                        ...
                                        if (fetchData.Result[i].Listing.Price != null && fetchData.Result[i].Listing.Price.Amount > 0)
                                        {
                                            ...
                                            Currency selectedCurrency = currency.Equals("divine") ? Currency.Divine : Currency.Chaos;
