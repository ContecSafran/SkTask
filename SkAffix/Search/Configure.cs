...
namespace Search
{
    ...
    {
        public static string PoeClass = "POEWindowClass";
        public static string PoeCaption = "Path of Exile";

        public static string LeaguesApi = "https://www.pathofexile.com/api/trade/data/leagues";
        public static string[] TradeUrl = { "https://poe.game.daum.net/trade/search/", "https://www.pathofexile.com/trade/search/" };
        public static string[] TradeApi = { "https://poe.game.daum.net/api/trade/search/", "https://www.pathofexile.com/api/trade/search/" };
        public static string[] FetchApi = { "https://poe.game.daum.net/api/trade/fetch/", "https://www.pathofexile.com/api/trade/fetch/" };
        public static string[] ExchangeUrl = { "https://poe.game.daum.net/trade/exchange/", "https://www.pathofexile.com/trade/exchange/" };
        public static string[] ExchangeApi = { "https://poe.game.daum.net/api/trade/exchange/", "https://www.pathofexile.com/api/trade/exchange/" };

        public static string UserAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.97 Safari/537.36";

        public static Dictionary<string, string> lFilterType = new Dictionary<string, string>()
        {
        ...
        /*
        public static Dictionary<string, bool> lDisable = new Dictionary<string, bool>()
        {
        ...
        */
        public static Dictionary<string, bool> lResistance = new Dictionary<string, bool>()
        {
        ...
        public static Dictionary<string, string> lPseudo = new Dictionary<string, string>()
        {
        ...
        public static ParserDict lRadius = new ParserDict()
        {
    ...
    {
        public static ConfigData mConfig;
        public static CheckedDict mChecked;

        public static ParserData mParser;
        //private ModsDict mMods;

        public static FilterData[] mStatic = new FilterData[2];
        public static FilterData[] mItems = new FilterData[2];
        public static FilterData[] mFilter = new FilterData[2];

        public static bool BasicDataUpdate(string path, string filename)
        {
            bool success = false;
            ...
            Thread thread = new Thread(() =>
            {
                ...
                string v_string = Api.SendHTTP(null, u, 3);
                if ((v_string ?? "") != "")
                {
        ...
        {
            string path = SkAffix.Constants.FilePath.resourcePath;
            FileStream fs = null;
        ...
        */
        ...
        public static bool LoadData(out string outString)
        {
            string path = SkAffix.Constants.FilePath.resourcePath;
            FileStream fs = null;
            string s = "";
