...
namespace Search
{
    ...
    */
    ...
    [DataContract]
    public class q_Type_filters_filters
    {
        [DataMember(Name = "category")]
    ...
    [DataContract]
    public class q_Socket_filters_filters
    {
        [DataMember(Name = "sockets")]
    ...
    [DataContract]
    public class q_Misc_filters_filters
    {
        [DataMember(Name = "quality")]
    ...
    [DataContract]
    public class q_Map_filters_filters
    {
        [DataMember(Name = "map_tier")]
    ...
    [DataContract]
    public class q_Heist_filters_filters
    {
    ...
    [DataContract]
    public class q_ultimatum_filters_filters
    {
    ...
    [DataContract]
    public class q_ultimatum_filters
    {
        [DataMember(Name = "disabled")]
        internal bool Disabled = false;
    ...
    [DataContract]
    public class q_Trade_filters_filters
    {
        [DataMember(Name = "indexed")]
    ...
    [DataContract]
    public class q_Disabled_filters
    {
        [DataMember(Name = "disabled")]
